...
const STORE_IDS = {
  freshMart: 'demo_store_freshmart_001',
  electroHub: 'demo_store_electrohub_002',
  greenField: 'demo_store_greenfield_003',
  agroBazar: 'demo_store_agrobazar_004',
  fixMaster: 'demo_store_fixmaster_005',
  cleanPro: 'demo_store_cleanpro_006',
};

export const demoMerchants = [
  {
    id: STORE_IDS.freshMart,
    ownerId: USER_IDS.nasreen,
    name: 'FreshMart Grocery',
    nameBn: 'ফ্রেশমার্ট গ্রোসারি',
    slug: 'freshmart-grocery',
    description: 'Premium grocery store with organic and imported items. Fresh vegetables, dairy, spices, and daily essentials delivered to your doorstep.',
    logoUrl: '',
    bannerUrl: '',
    category: 'grocery',
    subcategories: 'vegetables,dairy,spices,rice,snacks',
    tags: 'organic,fresh,delivery',
    isVerified: true,
    isLive: true,
    rating: 4.8,
    totalSales: 12450,
    totalReviews: 342,
    website: 'https://freshmart.com.bd',
    phone: '+8801711122334',
    email: 'info@freshmart.com.bd',
    address: '15/A Banani 11, Dhaka',
    city: 'Dhaka',
    district: 'Dhaka',
    division: 'Dhaka',
    latitude: 23.7937,
    longitude: 90.4143,
    createdAt: '2024-06-15T06:00:00.000Z',
    updatedAt: '2025-01-20T10:00:00.000Z',
    owner: { id: USER_IDS.nasreen, name: 'Nasreen Akter', avatarUrl: null },
    locations: [
      { id: 'demo_loc_fm1', ownerId: USER_IDS.nasreen, businessName: 'FreshMart - Banani', category: 'grocery', address: '15/A Banani 11', area: 'Banani', city: 'Dhaka', district: 'Dhaka', division: 'Dhaka', rating: 4.8, isOpen: true, phone: '+8801711122334' },
      { id: 'demo_loc_fm2', ownerId: USER_IDS.nasreen, businessName: 'FreshMart - Dhanmondi', category: 'grocery', address: '27/B Dhanmondi 8', area: 'Dhanmondi', city: 'Dhaka', district: 'Dhaka', division: 'Dhaka', rating: 4.7, isOpen: true, phone: '+8801711122335' },
      { id: 'demo_loc_fm3', ownerId: USER_IDS.nasreen, businessName: 'FreshMart - Gulshan', category: 'grocery', address: '56 Gulshan Avenue', area: 'Gulshan', city: 'Dhaka', district: 'Dhaka', division: 'Dhaka', rating: 4.9, isOpen: false, phone: '+8801711122336' },
    ],
    _count: { products: 156, farmProducts: 12, services: 0, inventoryItems: 168, locations: 3 },
    isOpen: true,
    openLocationCount: 2,
    primaryLocation: '15/A Banani 11, Dhaka',
    itemCount: 168,
  },
  {
    id: STORE_IDS.electroHub,
    ownerId: USER_IDS.jamal,
    name: 'ElectroHub Electronics',
    nameBn: 'ইলেক্ট্রোহাব ইলেকট্রনিক্স',
    slug: 'electrohub-electronics',
    description: 'Your one-stop electronics shop. Official dealer for Samsung, Xiaomi, and Walton. Best prices on phones, laptops, and accessories.',
    logoUrl: '',
    bannerUrl: '',
    category: 'electronics',
    subcategories: 'phones,laptops,accessories,appliances',
    tags: 'electronics,official_dealer,warranty',
    isVerified: true,
    isLive: true,
    rating: 4.6,
    totalSales: 8920,
    totalReviews: 215,
    website: 'https://electrohub.com.bd',
    phone: '+8801812345678',
    email: 'sales@electrohub.com.bd',
    address: '89/A Agrabad CDA Avenue, Chittagong',
    city: 'Chittagong',
    district: 'Chittagong',
    division: 'Chittagong',
    latitude: 22.3569,
    ...
    owner: { id: USER_IDS.jamal, name: 'Jamal Ahmed', avatarUrl: null },
    locations: [
      { id: 'demo_loc_eh1', ownerId: USER_IDS.jamal, businessName: 'ElectroHub - Agrabad', category: 'electronics', address: '89/A Agrabad CDA Avenue', area: 'Agrabad', city: 'Chittagong', district: 'Chittagong', division: 'Chittagong', rating: 4.6, isOpen: true, phone: '+8801812345678' },
    ],
    _count: { products: 89, farmProducts: 0, services: 2, inventoryItems: 91, locations: 1 },
    isOpen: true,
    openLocationCount: 1,
    primaryLocation: '89/A Agrabad CDA Avenue, Chittagong',
    itemCount: 91,
  },
  {
    id: STORE_IDS.greenField,
    ownerId: USER_IDS.karim,
    name: 'GreenField Agro',
    nameBn: 'গ্রিনফিল্ড এগ্রো',
    slug: 'greenfield-agro',
    description: 'Direct from farmers to your table. Organic rice, vegetables, and seasonal fruits from the fertile lands of Rajshahi.',
    logoUrl: '',
    bannerUrl: '',
    category: 'agriculture',
    subcategories: 'rice,vegetables,fruits,organic',
    tags: 'organic,farm_fresh,rajshahi',
    isVerified: true,
    isLive: true,
    rating: 4.9,
    totalSales: 6780,
    ...
    website: '',
    phone: '+8801911223344',
    email: 'greenfield@agro.com.bd',
    address: '12 Rajpara, Rajshahi',
    city: 'Rajshahi',
    district: 'Rajshahi',
    division: 'Rajshahi',
    latitude: 24.3745,
    longitude: 88.6042,
    createdAt: '2024-05-10T06:00:00.000Z',
    updatedAt: '2025-01-20T10:00:00.000Z',
    owner: { id: USER_IDS.karim, name: 'Karim Hossain', avatarUrl: null },
    locations: [
      { id: 'demo_loc_gf1', ownerId: USER_IDS.karim, businessName: 'GreenField - Rajpara', category: 'agriculture', address: '12 Rajpara', area: 'Rajpara', city: 'Rajshahi', district: 'Rajshahi', division: 'Rajshahi', rating: 4.9, isOpen: true, phone: '+8801911223344' },
      { id: 'demo_loc_gf2', ownerId: USER_IDS.karim, businessName: 'GreenField - Shaheb Bazar', category: 'agriculture', address: '45 Shaheb Bazar', area: 'Shaheb Bazar', city: 'Rajshahi', district: 'Rajshahi', division: 'Rajshahi', rating: 4.8, isOpen: true, phone: '+8801911223345' },
    ],
    _count: { products: 34, farmProducts: 28, services: 0, inventoryItems: 62, locations: 2 },
    isOpen: true,
    openLocationCount: 2,
    primaryLocation: '12 Rajpara, Rajshahi',
    itemCount: 62,
  },
  {
    id: STORE_IDS.agroBazar,
    ownerId: USER_IDS.fatema,
    name: 'AgroBazar Sylhet',
    nameBn: 'অ্যাগ্রোবাজার সিলেট',
    slug: 'agrobazar-sylhet',
    description: 'Specializing in tea garden produce and organic items from the Surma Valley. Premium quality tea, betel leaf, and citrus fruits.',
    logoUrl: '',
    bannerUrl: '',
    category: 'agriculture',
    subcategories: 'tea,fruits,spices,organic',
    tags: 'tea,organic,sylhet,premium',
    isVerified: false,
    isLive: true,
    rating: 4.3,
    totalSales: 3200,
    ...
    website: '',
    phone: '+8801611223345',
    email: 'info@agrobazar.com.bd',
    address: '34 Zindabazar, Sylhet',
    city: 'Sylhet',
    district: 'Sylhet',
    division: 'Sylhet',
    latitude: 24.8949,
    ...
    updatedAt: '2025-01-18T10:00:00.000Z',
    owner: { id: USER_IDS.fatema, name: 'Fatema Begum', avatarUrl: null },
    locations: [
      { id: 'demo_loc_ab1', ownerId: USER_IDS.fatema, businessName: 'AgroBazar - Zindabazar', category: 'agriculture', address: '34 Zindabazar', area: 'Zindabazar', city: 'Sylhet', district: 'Sylhet', division: 'Sylhet', rating: 4.3, isOpen: true, phone: '+8801611223345' },
    ],
    _count: { products: 22, farmProducts: 18, services: 0, inventoryItems: 40, locations: 1 },
    isOpen: true,
    openLocationCount: 1,
    primaryLocation: '34 Zindabazar, Sylhet',
    itemCount: 40,
  },
  {
    id: STORE_IDS.fixMaster,
    ownerId: USER_IDS.abdul,
    name: 'FixMaster Services',
    nameBn: 'ফিক্সমাস্টার সার্ভিসেস',
    slug: 'fixmaster-services',
    description: 'Professional home repair and maintenance services. Electrical, plumbing, AC repair, and more. Licensed technicians, guaranteed work.',
    logoUrl: '',
    bannerUrl: '',
    category: 'services',
    subcategories: 'electrical,plumbing,ac_service,auto_repair',
    tags: 'repair,maintenance,home_services',
    isVerified: true,
    isLive: true,
    rating: 4.7,
    totalSales: 5640,
    totalReviews: 156,
    website: 'https://fixmaster.com.bd',
    phone: '+8801511223345',
    email: 'book@fixmaster.com.bd',
    address: '78 Sonargaon Janapath, Dhaka',
    city: 'Dhaka',
    district: 'Dhaka',
    division: 'Dhaka',
    latitude: 23.8103,
    longitude: 90.4125,
    createdAt: '2024-04-05T06:00:00.000Z',
    updatedAt: '2025-01-20T10:00:00.000Z',
    owner: { id: USER_IDS.abdul, name: 'Abdul Rahman', avatarUrl: null },
    locations: [
      { id: 'demo_loc_fm_1', ownerId: USER_IDS.abdul, businessName: 'FixMaster - Motijheel', category: 'services', address: '78 Sonargaon Janapath', area: 'Motijheel', city: 'Dhaka', district: 'Dhaka', division: 'Dhaka', rating: 4.7, isOpen: true, phone: '+8801511223345' },
      { id: 'demo_loc_fm_2', ownerId: USER_IDS.abdul, businessName: 'FixMaster - Mirpur', category: 'services', address: '10 Mirpur 10', area: 'Mirpur', city: 'Dhaka', district: 'Dhaka', division: 'Dhaka', rating: 4.6, isOpen: true, phone: '+8801511223346' },
      { id: 'demo_loc_fm_3', ownerId: USER_IDS.abdul, businessName: 'FixMaster - Uttara', category: 'services', address: '5 Sector 7, Uttara', area: 'Uttara', city: 'Dhaka', district: 'Dhaka', division: 'Dhaka', rating: 4.5, isOpen: false, phone: '+8801511223347' },
    ],
    _count: { products: 15, farmProducts: 0, services: 8, inventoryItems: 23, locations: 3 },
    isOpen: true,
    openLocationCount: 2,
    primaryLocation: '78 Sonargaon Janapath, Dhaka',
    itemCount: 23,
  },
  {
    id: STORE_IDS.cleanPro,
    ownerId: USER_IDS.nasreen,
    name: 'CleanPro Home Services',
    nameBn: 'ক্লিনপ্রো হোম সার্ভিসেস',
    slug: 'cleanpro-home-services',
    description: 'Deep cleaning, pest control, and home maintenance in Khulna. Professional team with eco-friendly products.',
    logoUrl: '',
    bannerUrl: '',
    category: 'services',
    subcategories: 'cleaning,pest_control,maintenance',
    tags: 'cleaning,home_services,eco_friendly',
    isVerified: false,
    isLive: false,
    rating: 4.2,
    totalSales: 1890,
    ...
    website: '',
    phone: '+8801411223345',
    email: 'cleanpro@services.com.bd',
    address: '22 Sonadanga, Khulna',
    city: 'Khulna',
    district: 'Khulna',
    division: 'Khulna',
    latitude: 22.8456,
    longitude: 89.5403,
    createdAt: '2024-10-15T06:00:00.000Z',
    updatedAt: '2025-01-15T10:00:00.000Z',
    owner: { id: USER_IDS.nasreen, name: 'Nasreen Akter', avatarUrl: null },
    locations: [
      { id: 'demo_loc_cp1', ownerId: USER_IDS.nasreen, businessName: 'CleanPro - Sonadanga', category: 'services', address: '22 Sonadanga', area: 'Sonadanga', city: 'Khulna', district: 'Khulna', division: 'Khulna', rating: 4.2, isOpen: true, phone: '+8801411223345' },
    ],
    _count: { products: 8, farmProducts: 0, services: 5, inventoryItems: 13, locations: 1 },
    isOpen: true,
    openLocationCount: 1,
    primaryLocation: '22 Sonadanga, Khulna',
    itemCount: 13,
  },
];

// ============ MERCHANT DETAIL (single store) ============

export const demoMerchantDetail = {
  ...demoMerchants[0],
  inventoryItems: [
    { id: 'demo_inv_001', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.honey, sku: 'FM-HNY-001', stock: 50, reserved: 5, price: 180000, syncSource: 'pos', lastSyncedAt: '2025-01-20T09:30:00.000Z', createdAt: '2025-01-20T09:30:00.000Z', updatedAt: '2025-01-20T09:30:00.000Z' },
    { id: 'demo_inv_002', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.hilsha, sku: 'FM-HLS-002', stock: 30, reserved: 3, price: 120000, syncSource: 'pos', lastSyncedAt: '2025-01-20T09:25:00.000Z', createdAt: '2025-01-19T10:00:00.000Z', updatedAt: '2025-01-20T09:25:00.000Z' },
    { id: 'demo_inv_003', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.coconutOil, sku: 'FM-COC-003', stock: 300, reserved: 20, price: 9500, syncSource: 'pos', lastSyncedAt: '2025-01-20T09:20:00.000Z', createdAt: '2025-01-18T10:00:00.000Z', updatedAt: '2025-01-20T09:20:00.000Z' },
    { id: 'demo_inv_004', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.panjabi, sku: 'FM-PNJ-004', stock: 25, reserved: 2, price: 350000, syncSource: 'manual', lastSyncedAt: '2025-01-18T15:00:00.000Z', createdAt: '2025-01-17T10:00:00.000Z', updatedAt: '2025-01-18T15:00:00.000Z' },
    { id: 'demo_inv_005', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.saree, sku: 'FM-SRI-005', stock: 12, reserved: 1, price: 850000, syncSource: 'manual', lastSyncedAt: '2025-01-17T14:00:00.000Z', createdAt: '2025-01-16T10:00:00.000Z', updatedAt: '2025-01-17T14:00:00.000Z' },
    { id: 'demo_inv_006', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.dal, sku: 'FM-DAL-006', stock: 80, reserved: 10, price: 15000, syncSource: 'pos', lastSyncedAt: '2025-01-20T09:15:00.000Z', createdAt: '2025-01-15T10:00:00.000Z', updatedAt: '2025-01-20T09:15:00.000Z' },
    { id: 'demo_inv_007', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.milk, sku: 'FM-MLK-007', stock: 3, reserved: 0, price: 8500, syncSource: 'pos', lastSyncedAt: '2025-01-20T09:10:00.000Z', createdAt: '2025-01-14T10:00:00.000Z', updatedAt: '2025-01-20T09:10:00.000Z' },
    { id: 'demo_inv_008', storeId: STORE_IDS.freshMart, entityType: 'product', entityId: PRODUCT_IDS.basmatiRice, sku: 'FM-RCE-008', stock: 150, reserved: 15, price: 12000, syncSource: 'pos', lastSyncedAt: '2025-01-20T09:05:00.000Z', createdAt: '2025-01-13T10:00:00.000Z', updatedAt: '2025-01-20T09:05:00.000Z' },
  ],
  products: demoProducts.map(p => ({ ...p, avgRating: p.rating })),
  farmProducts: [
    { id: 'demo_farm_fm1', farmerId: USER_IDS.nasreen, name: 'Organic Litchi', nameBn: 'জৈব লিচু', description: 'Fresh litchi from Dinajpur orchards.', price: 6000, unit: 'kg', category: 'fruits', imageUrl: '', quantity: 80, origin: 'Dinajpur', isOrganic: true, harvestDate: '2025-05-01', isActive: true, createdAt: '2025-01-19T10:00:00.000Z', updatedAt: '2025-01-19T10:00:00.000Z', farmer: { id: USER_IDS.nasreen, name: 'Nasreen Akter', city: 'Dhaka', avatarUrl: null } },
  ],
  services: [
    { id: 'demo_svc_fm1', providerId: USER_IDS.nasreen, name: 'Gift Packaging Service', nameBn: 'গিফট প্যাকেজিং সার্ভিস', description: 'Premium gift wrapping and packaging for products purchased from FreshMart.', category: 'business', subcategory: 'packaging', priceType: 'fixed', basePrice: 500, imageUrl: '', rating: 4.5, reviewCount: 12, isAvailable: true, serviceType: 'in_venue', createdAt: '2025-01-15T10:00:00.000Z', updatedAt: '2025-01-15T10:00:00.000Z', provider: { id: USER_IDS.nasreen, name: 'Nasreen Akter', avatarUrl: null, city: 'Dhaka' } },
  ],
  recentOrders: [
    { id: 'demo_order_fm1', buyerId: USER_IDS.rahim, sellerId: USER_IDS.nasreen, totalAmount: 129500, status: 'preparing', paymentStatus: 'paid', paymentMethod: 'wallet', deliveryType: 'home_delivery', deliveryAddress: '45 Dhanmondi 27, Dhaka', createdAt: '2025-01-20T12:00:00.000Z', updatedAt: '2025-01-20T12:00:00.000Z', buyer: { id: USER_IDS.rahim, name: 'Rahim Uddin' } },
    { id: 'demo_order_fm2', buyerId: USER_IDS.fatema, sellerId: USER_IDS.nasreen, totalAmount: 850000, status: 'confirmed', paymentStatus: 'paid', paymentMethod: 'Nagad', deliveryType: 'pickup', deliveryAddress: null, createdAt: '2025-01-17T09:00:00.000Z', updatedAt: '2025-01-17T09:00:00.000Z', buyer: { id: USER_IDS.fatema, name: 'Fatema Begum' } },
    { id: 'demo_order_fm3', buyerId: USER_IDS.karim, sellerId: USER_IDS.nasreen, totalAmount: 34500, status: 'delivered', paymentStatus: 'paid', paymentMethod: 'wallet', deliveryType: 'home_delivery', deliveryAddress: '12 Rajpara, Rajshahi', createdAt: '2025-01-14T11:00:00.000Z', updatedAt: '2025-01-16T10:00:00.000Z', buyer: { id: USER_IDS.karim, name: 'Karim Hossain' } },
  ],
  inventorySyncPercentage: 87.5,
  avgSyncAgeMinutes: 45,
  lowStockItems: 3,
  liveInventoryCount: 8,
};
...
export const demoData = {
  ...
  merchantDetail: demoMerchantDetail,
};